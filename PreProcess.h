...
public:
    ...
    ~PreProcess();
    void removeEog(double *sig, int row, int column, int eogrow);
    void filterPoint(double *sig, int row, int length, int eogrow);
    void Segmentation(double *sig, int siglenth,                       // raw data and its length
